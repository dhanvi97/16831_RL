...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        random_index_list = np.random.permutation(self.obs.shape[0])
        batched_list = random_index_list[-batch_size:]
        return (
            self.obs[batched_list],
            self.acs[batched_list],
            self.rews[batched_list],
            self.next_obs[batched_list],
            self.terminals[batched_list]
        )
